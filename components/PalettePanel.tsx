...
import { Palette, Plus, Trash2, Save, Palette as PaletteIcon, Check } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-gray-900 text-white border-l border-gray-750">
      ...
      <div className="p-3 space-y-4 flex-1 overflow-y-auto">
        ...
        <div className="space-y-2">
          <label className="text-xs text-gray-400 font-medium">Active Palette</label>
                ...
                >
                   ...
                   {primaryColor === color && (
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                          <div className="w-1.5 h-1.5 bg-white rounded-full shadow-sm drop-shadow-md"></div>
                      </div>
                   )}
                </div>
              ))}
        ...
        <div className="flex items-center justify-between bg-gray-800 p-2 rounded border border-gray-700">
             <div className="flex items-center gap-2">
                 <div className="w-6 h-6 rounded border border-gray-600" style={{ backgroundColor: primaryColor }}></div>
                 <span className="text-xs font-mono text-gray-300">{primaryColor.toUpperCase()}</span>
             </div>
             <button 
               onClick={addColor} 
